...
//find camel should only ever be called by the findContig function!
//findCamel finds instances of camel case (uppercase character followed
//by a lower case) and will return an bonus score
